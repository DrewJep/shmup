...
private:
    ...
    // Animation
    static std::unique_ptr<sf::Texture> texture; // default UFO texture
    static std::unique_ptr<sf::Texture> tankTexture; // optional tank texture
